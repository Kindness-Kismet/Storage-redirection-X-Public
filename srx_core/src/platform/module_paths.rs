...
pub const SYSTEM_WRITER_UIDS_FILE: &str = "/dev/srx_config/system_writer_uids.list";
pub const LOG_DIR: &str = "/data/adb/modules/storage.redirect.x/logs";
pub const MOUNT_STATE_DIR: &str = "/data/adb/modules/storage.redirect.x/mount_state";
